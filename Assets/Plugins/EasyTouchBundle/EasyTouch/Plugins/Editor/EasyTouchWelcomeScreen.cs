...
public class EasyTouchWelcomeScreen : EditorWindow
{
    ...
    public static void JsFolders()
    {
        ...
        {
            Debug.LogWarning(
                "Folder structure incompatible, did you already switch to JS folder structure, or have you manually changed the folder structure?");
            return;
        }
        ...
        AssetDatabase.MoveAsset("Assets/EasyTouchBundle/EasyTouch/Plugins/Components",
            "Assets/Plugins/EasyTouch/Components");
    ...
    public static void CFolders()
    {
        ...
        {
            Debug.LogWarning(
                "Folder structure incompatible, are you already using original folder structure, or have you manually changed the folder structure?");
            return;
        }

        AssetDatabase.MoveAsset("Assets/Plugins/EasyTouch/Components",
            "Assets/EasyTouchBundle/EasyTouch/Plugins/Components");
        ...
        EditorApplication.OpenProject(Application.dataPath.Remove(Application.dataPath.Length - "Assets".Length,
            "Assets".Length));
    }
